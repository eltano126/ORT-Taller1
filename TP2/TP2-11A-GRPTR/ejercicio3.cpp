...
void main(){
	...
	ty_Examen tyExamen;
	int iCantEval, iCantAlum, iCantEvalProc, iAcumNotas, iCalifBaja, iCont0;
	float fPromCalif;
	char cSigue, cSigueCalif;

	//Inicializacion de Variables:
	tyExamen.iMatricula = tyExamen.iCalif = iCantEval = iCantAlum = iCantEvalProc = iAcumNotas = iCont0 = 0;
	iCalifBaja = 10;
	fPromCalif = 0;
